...
render() {
    ...
    <title> AcceptMyCrypto FAQs </title> 
         ...
         <a className="Faq-menuItem" id="general">
         
                  General
            </a>

            <a className="Faq-menuItem" id="seller">
                  Sellers
           </a>
...
<UncontrolledCollapse toggler="#togglerQuestion3">
      <CardBody>
            <ul className="Faq-qnaList">
              <li className="Faq-answer">If you have any questions or concerns regarding listing items or services on AcceptMyCrypto please don’t hesitate to contact us. We will respond to you within 24 hours.</li>
            </ul>
      </CardBody>
</UncontrolledCollapse>
...
<UncontrolledCollapse toggler="#togglerQuestion12">
      ...
      <CardBody>
          <ul className="Faq-qnaList">
            <li className="Faq-answer"> A request to close/cancel your account can be made through our Contact us link in the footer of the Home page or by clicking the link provided. We will respond within 24 hours of receipt and provide you with any further instructions, if applicable.</li>
...
<UncontrolledCollapse toggler="#togglerSellerQues8">
        ...
        <CardBody>
            <ul className="Faq-qnaList">
              ...
              <li className="Faq-answer">-Note- It is important that you enter in the address of the cryptocurrency you would like to receive the funds in. The type of cryptocurrency the item is being sold for and the type of cryptocurrency that is being received MUST match.  For example, if the buyer pays in Bitcoin Cash, you must have the address of Bitcoin cash in order to receive the funds. We’re not responsible for invalid addresses. In the event there is an invalid address provided please contact us for further instructions.</li>
            </ul>
        </CardBody>
