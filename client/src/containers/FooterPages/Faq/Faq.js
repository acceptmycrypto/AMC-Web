              ...
              <div id="general">
                <div class="card-body">
                  ...
                  <UncontrolledCollapse toggler="#togglerQuestion1">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        Acceptmycrypto is a marketplace that allows individuals
                        to buy and sell items/services at a discount price in
                        cryptocurrencies. Sellers can create deals for sales
                        with the option to get paid in fiat or cryptos from the
                        buyers. It was created to assist in the acceptance of
                        cryptocurrencies as a viable form of payment, which is
                        why listings have a lower price in cryptocurrency.
                      </li>
                    </ul>
                  ...
                  <UncontrolledCollapse toggler="#togglerQuestion3">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        items or services on AcceptMyCrypto, please don’t
                        hesitate to contact us at support@acceptmycrypto.com. We
                        will respond to you within 2 business days.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerQuestion4">
                    <ul className="Faq-qnaList">
                      ...
                      <li className="Faq-answerNote">
                        Note -- We are unable to verify international, prepaid,
                        or VoIP phone numbers.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerQuestion6">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        We offer the benefit of processing payments in Us
                        dollars (through Paypal) and Cryptocurrency (through
                        Coinpayments).
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerQuestion10">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        The seller will be able to and should add the
                        appropriate state’s sales tax to the item(s) being sold.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerQuestion11">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        time. International shipping through our platform will
                        not be accepted.
                      </li>
                      <li className="Faq-answer">
                      ...
                      <li className="Faq-answer">
                        AcceptMyCrypto does not cover any shipping costs on
                        behalf of the buyer or seller. All sellers are hereby
                        advised, they will be responsible for any shipping
                        fee/costs. Sellers will have the ability to add such
                        fees/costs to the price of the item being sent or cover
                        the fees/costs all together to provide free shipping to
                        their customers. This is at the full discretion of the
                        seller.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerQuestion12">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        {" "}
                        A request to close/cancel your account can be made
                        through emailing us at support@acceptmycrypto.com. We
                        will respond within 2 business days of receipt and
                        provide you with any further instructions, if
                        applicable.
                      </li>
                      <li className="Faq-answer">
                        {" "}
                        The account cannot be closed/canceled if there exists
                        any open/pending sales or transactions at the time of
                        the request. The request will be denied and will need to
                        be re-submitted after ALL open/pending sales and
              ...
              <div id="sellers">
                <div class="card-body">
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues1">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        AcceptMyCrypto is built to be the easiest marketplace
                        for sellers to create a sale and get paid in
                        cryptocurrencies they desired to accept from the buyers.
                        When you become a seller, you get to used our platform
                        for free and have access over all the tools such as
                        messaging, shipping, crypto payment processing and
                        others that help to facilitate a successful transaction
                        with the buyer. We also have an internal support team
                        that work 24/7 to ensure you get all the support you
                        need to be a successful seller on AcceptMyCrypto. If you
                        have feedback in making our platform better for you to
                        make a successful sale, please don’t hesitate to contact
                        us at support@acceptmycrypto.com. We’d love to work with
                        you.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues2">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        You can create a user account by signing up from our
                        home page and start listing right away.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues3">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        Please refer to our step-by-step guide on how to Create
                        a Deal.
                      </li>
                      <li className="Faq-answer">
                        Once you setup your profile and log on you will see a
                        Create a Deal link at the top of the page. You simply
                        fill out the form with as much detail as possible about
                        the item or service you are listing.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues5">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        Some products may not be listed as a matter of
                        compliance with legal or regulatory restrictions (for
                        example, prescription drugs) or AcceptMyCrypto policy
                        (for example, crime scene photos). For detailed
                        information, please see our Restricted Products Help
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues6">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        cryptocurrencies. Sellers have the flexibility to choose
                        a price for their listing but we require that the
                        cryptocurrency price has at minimum 10% discount from
                        the cash price.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues8">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        We will first collect the funds from the buyers. Once
                        this is successful we notify the seller on the sellers
                        profile and through a “Funds received” email.
                      </li>
                      <li className="Faq-answer">
                        After receiving the “Funds received” email your next
                        step as the seller would be to send out the item(s) or
                        provide confirmation for any service.
                      </li>
                      <li className="Faq-answer">
                        A completed sale refers to the funds being received by
                        us from the buyer and we have received tracking
                        information and/or confirmation for the item(s) and/or
                        service(s) from the seller.
                      </li>
                      <li className="Faq-answer">
                        Once these criterias are met we will transfer the funds
                        of a completed sale to the wallet we have on file.
                      </li>
                      <li className="Faq-answerNote">
                        Note -- It is important that you enter in the address of
                        the cryptocurrency you would like to receive the funds
                        in.
                      </li>
                      <li className="Faq-answerNote">
                        The type of cryptocurrency the item is being sold for
                        and the type of cryptocurrency that is being received
                        MUST match. For example, if the buyer pays in Bitcoin
                        Cash, you must have the address of Bitcoin cash in order
                        to receive the funds. We’re not responsible for invalid
                        addresses.
                      </li>
                      <li className="Faq-answerNote">
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues9">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        10%. These fees are subject to change at any time with
                  ...
                  <ul className="Faq-qnaList">
                    <li>
                      <h4>
                        ...
                        >
                          Does AcceptMyCyrpto provide tax documents at the end
                          of the year?
                        </Button>
                      </h4>
                    </li>
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues11">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        Yes. You are able to cancel or delete a listing as long
                        as the listing is not in a "pending" or "sold" state.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues12">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        account. The account holder will be able to toggle
                        between purchases and sales as to ease the visibility of
                        the profile.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues14">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        Once we have received the funds from the buyer
                        (processed through Coinpayments or Paypal) we will send
                        you a “Funds received” email explaining any further
                        steps needed.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <ul className="Faq-qnaList">
                    <li>
                      <h4>
                        ...
                        >
                          Can I offer gift-wrap and gift messaging services to
                          my customers on AcceptMyCrypto.com?
                        </Button>
                      </h4>
                    </li>
                  </ul>
                  ...
                  <UncontrolledCollapse toggler="#togglerSellerQues15">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        able to offer this service to your customers. This
                        should be something that you add to the description
                        section of your Deal being posted. AcceptMyCrypto is not
                        responsible for any gifting options of any product or
                        service sold through our platform.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                </div>
              ...
              <div id="buyers">
                <div class="card-body">
                  ...
                  <UncontrolledCollapse toggler="#togglerBuyersQues1">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        accepts for their individual listings. AccpetMyCrypto
                        has no control over which type Cryptocurrency the seller
                        will accept.
                      </li>
                      <li className="Faq-answer">
                        Currently, we allow each seller the ability to accept up
                        to 10 different cryptocurrencies. If your Cryptocurrency
                        of choice is not listed, please submit a
                        "AcceptMyCrypto" request.
                      </li>
                      <li className="Faq-answer">
                  ...
                  <UncontrolledCollapse toggler="#togglerBuyersQues2">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        may arise are listed under our Returns/Refunds section
                      ...
                      <li className="Faq-answer">
                        ...
                        acts of discrimination or violence (written or
                        otherwise). Any account suspected of such acts will be
                        deactivated and the user blocked from the platform.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerBuyersQues3">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        policy. Some may offer returns and some may not. For
                        more information on this topic please refer to the
                        individual seller and/or thier listing. You may also
                        refer to our Return/Refund policy located in the footer
                        of the Home page or click the link provided.
                      </li>
                      <li className="Faq-answer">
                        For fraudulent listings, If we determine that a listing
                        is fake and/or fraudulent in any way we will make all
                        efforts to ensure you receive your funds back (if a
                        successful payment has already been processed).
                      </li>
                      <li className="Faq-answer">
                        For any accepted Returns/Refunds AcceptMyCrypto will
                        subtract a 2.5% processing fee from the amount of the
                        refund. These are charges that AcceptMyCrypto has
                  ...
                  <UncontrolledCollapse toggler="#togglerBuyersQues4">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        The buyer has 15 minutes to pay for the
                        item(s)/service(s) before the transaction auto-cancels.
                        If payment has not been received in this window of time
                        the transaction will be canceled and the
                        item(s)/service(s) will become available for purchase
                        again.
                      </li>
                      <li className="Faq-answer">
                  ...
                  <UncontrolledCollapse toggler="#togglerBuyersQues6">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        ...
                        Message button to start the conversation with the
                        seller.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
              ...
              <div id="guest">
                <div class="card-body">
                  ...
                  <ul className="Faq-qnaList">
                    <li>
                      <h4>
                        ...
                        >
                          How can I purchase an item on AcceptMyCrypto as a
                          guest?
                        </Button>
                      </h4>
                    </li>
                  ...
                  <UncontrolledCollapse toggler="#togglerGuestQues1">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        AcceptMyCrypto does not require you to open an account
                        in order to purchase item(s)/service(s). We will still
                        need to collect some personal information to process
                        your orders such an email address, mailing address,
                  ...
                  <UncontrolledCollapse toggler="#togglerGuestQues2">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        Yes. You will receive a confirmation when the ordered
                        has been confirmed as well as an email with your
                        tracking information. This is why we will need to gather
                        your email address when purchasing an item/service.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerGuestQues4">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        As a guest, all sales are final unless we have
                        determined the transaction to be fraudulent. Registering
                        an account will allow you to contact the seller directly
                        as well as the ability to take advantage of their return
                        policy, where applicable. You can register a new account
                        here.
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                  ...
                  <UncontrolledCollapse toggler="#togglerGuestQues5">
                    <ul className="Faq-qnaList">
                      <li className="Faq-answer">
                        The registration process is a quick and easy one that
                        will allow you to become a part of a new and exciting
                        Crypto Marketplace. Let’s get you registered and
                        connected with other Cryptocurrency holders and
                        enthusiasts. Register here!
                      </li>
                    </ul>
                  </UncontrolledCollapse>
                </div>
