          ...
          <div id="general">
            <div class="card-body">
              ...
              <UncontrolledCollapse toggler="#togglerQuestion2">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    If you would like to have a listing then yes you would need
                    to create an account. There is an option for guest checkout
                    as a buyer, however, we advise you to create a profile for a
              ...
              <UncontrolledCollapse toggler="#togglerQuestion3">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    to contact us at support@acceptmycrypto.com. We will respond
              ...
              <UncontrolledCollapse toggler="#togglerQuestion4">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    numbers to confirm they’re a real person as well as to help
                    in the recovery of a lost account.
                  </li>
                  ...
                  <li className="Faq-answer">
                    After verifying your phone number, you will not receive any
                    calls or text messages from AcceptMyCrypto.
                  </li>
              ...
              <UncontrolledCollapse toggler="#togglerQuestion6">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    (through Paypal) and Cryptocurrency (through Coinpayments).
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerQuestion9">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    If you are under 18, you may use the AcceptMyCrypto Services
                    explicitly with involvement of a parent or guardian. Parents
                    and guardians may create profiles for their minors.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerQuestion11">
                <ul className="Faq-qnaList">
                  ...
                  <li className="Faq-answer">
                    ...
                    of the buyer or seller. All sellers are hereby advised, they
                    will be responsible for any shipping fee/costs. Sellers will
                    have the ability to add such fees/costs to the price of the
                    item being sent or cover the fees/costs all together to
                    provide free shipping to their customers. This is at the
            ...
            <div class="card-body">
              ...
              <UncontrolledCollapse toggler="#togglerSellerQues1">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    crypto payment processing and others that help to facilitate
                    a successful transaction with the buyer. We also have an
                    internal support team that work 24/7 to ensure you get all
                    the support you need to be a successful seller on
                    AcceptMyCrypto. If you have feedback in making our platform
                    better for you to make a successful sale, please don’t
                    hesitate to contact us at support@acceptmycrypto.com. We’d
              ...
              <UncontrolledCollapse toggler="#togglerSellerQues3">
                <ul className="Faq-qnaList">
                  ...
                  <li className="Faq-answer">
                    Once you setup your profile and log on you will see a Create
                    a Deal link at the top of the page. You simply fill out the
                    form with as much detail as possible about the item or
                    service you are listing.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerSellerQues4">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    In order to provide an accurate and fair search function on
                    our site, prior approval may be required to list certain
              ...
              <UncontrolledCollapse toggler="#togglerSellerQues7">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    Utilizing Coinpayments and Paypal provides fraud protection
                    through the electronic processing of monetary transfers.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerSellerQues8">
                <ul className="Faq-qnaList">
                  ...
                  <li className="Faq-answer">
                    After receiving the “Funds received” email your next step as
                    the seller would be to send out the item(s) or provide
                  ...
                  <li className="Faq-answer">
                    Once these criterias are met we will transfer the funds of a
                    completed sale to the wallet we have on file.
                  </li>
                  <li className="Faq-answerNote">
                    Note -- It is important that you enter in the address of the
                    cryptocurrency you would like to receive the funds in.
                  </li>
                  <li className="Faq-answerNote">
              ...
              <UncontrolledCollapse toggler="#togglerSellerQues9">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    AcceptMyCrypto charges a small 2.5 % fee for each item sold
                    or service provided through our Crypto Marketplace when payment is received in crypto. If buyer decides to pay the base price with fiat via paypal, then the fee is 10%. These
                    fees are subject to change at any time with or without
                    notification.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerSellerQues13">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    You can create a new listing/deal through the Create a Deal
                    link at the top of the page. Please refer to our
                    step-by-step instructions on how to Create a Deal using the
                    link provided.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerSellerQues15">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    able to offer this service to your customers. This should be
                    something that you add to the description section of your
                    Deal being posted. AcceptMyCrypto is not responsible for any
                    gifting options of any product or service sold through our
                    platform.
                  </li>
                </ul>
              </UncontrolledCollapse>
          ...
          <div id="buyers">
            <div class="card-body">
              ...
              <ul className="Faq-qnaList">
                <li>
                  <h4>
                    ...
                    >
                      The cryptocurrency I want to use is not supported on your
                      site, what can I do?
                    </Button>
                  </h4>
                </li>
              ...
              <UncontrolledCollapse toggler="#togglerBuyersQues1">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    accepts for their individual listings. AccpetMyCrypto has no
                    control over which type Cryptocurrency the seller will
                    accept.
                  </li>
                  <li className="Faq-answer">
                    Currently, we allow each seller the ability to accept up to
                    10 different cryptocurrencies. If your Cryptocurrency of
                    choice is not listed, please submit a "AcceptMyCrypto"
                    request.
                  </li>
                  <li className="Faq-answer">
                    If there is a high demand for any given Crypto, then, where
                    possible, we will be sure to add it as an "AcceptedCrypto"
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerBuyersQues2">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    The details of returns, exchanges and other issues that may
                    arise are listed under our Returns/Refunds section in the
                    footer of the Home page.
                  </li>
                  <li className="Faq-answer">
                    Typically any issues that may arise are handled between the
                    buyer and the seller. If communications between the buyer
                    and seller becomes unproductive and/of volatile
                    AcceptMyCrypto will step in and attempt to mediate and
                    resolve the issue. AcceptMyCrypto does not condone ANY acts
                    of discrimination or violence (written or otherwise). Any
                    account suspected of such acts will be deactivated and the
                    user blocked from the platform.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerBuyersQues3">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    Return/Refund policy located in the footer of the Home page
              ...
              <UncontrolledCollapse toggler="#togglerBuyersQues4">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    before the transaction auto-cancels. If payment has not been
                    received in this window of time the transaction will be
                    canceled and the item(s)/service(s) will become available
                    for purchase again.
                  </li>
                  <li className="Faq-answer">
                    If the payment has been accepted and received, please refer
                    to our Return/Refund policy in the footer of the Home page
                    or click the link provided for further instructions.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerBuyersQues5">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    account) is located in your profile page. Yes. please visit
                    your profile page
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerBuyersQues6">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    Buyer can contact Seller anytime using the messaging feature. Sign in and locate the Message button at the bottom of the deal item you're interested. Click the Message button to start the conversation with the seller.
                  </li>
                </ul>
              </UncontrolledCollapse>
            </div>
              ...
              <UncontrolledCollapse toggler="#togglerGuestQues1">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    order to purchase item(s)/service(s). We will still need to
                    collect some personal information to process your orders
                    such an email address, mailing address, billing information,
                    etc.
                  </li>
                  <li className="Faq-answer">
                    For you to have the full experience of our Marketplace (ie.
                    contact directly with the seller, purchase history, crypto
                    market trends, etc.) we encourage you to register an account
                    and begin shopping.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerGuestQues4">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    will allow you to contact the seller directly as well as the
                    ability to take advantage of their return policy, where
                    applicable. You can register a new account here.
                  </li>
                </ul>
              </UncontrolledCollapse>
              ...
              <UncontrolledCollapse toggler="#togglerGuestQues5">
                <ul className="Faq-qnaList">
                  <li className="Faq-answer">
                    ...
                    other Cryptocurrency holders and enthusiasts. Register here!
                  </li>
                </ul>
              </UncontrolledCollapse>
            </div>
