  ...
  return (
    <div>
      {!props.paymentButtonClicked ? (
        <div className="payment-form">
          <form>
            <div class="form-group">
              <label
                className="text-capitalize payment-name-label"
                htmlFor="select_crypto"
              >
                Select the Cryptocurrency to pay with
              </label>
              <Select
                id="select_crypto"
                required
            ...
            <div className="dealitem-error-msg" id="selected-payment-error" />
          </form>

          <div id="payment-divider">OR</div>
          <div id="paypal-button">
            <strong>
              {props.isLoggedin ? "Pay in USD" : "Sign in to pay in USD"}
            </strong>
            {props.isLoggedin && (
              <PaypalButton
          ...
          <div>
            <div
              onClick={props.previous_step}
              className="payment-previous-step button"
            >
              <button>Previous</button>
            </div>
            <div
              onClick={() =>
                props.validatePaymentData() && props.SubmitPayment()
              }
        ...
        <Checkout
          showTimeout={props.timeout}
          showTransaction={props.transactionInfo}
          showPaidIn={props.cryptoSymbol}
        />
      )}
    </div>
  );
