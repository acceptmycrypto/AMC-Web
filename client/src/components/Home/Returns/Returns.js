          ...
          <div className="Returns-mainContent">
            ...
            <ul className="returns-listItem">
              <li>
                ...
                applicable), and/or the transaction was proven to be fraudulent.
              </li>
            </ul>
            ...
            <ul className="returns-listItem">
              <li>
                ...
                your return is approved, then your replacement or refund will be
                processed and a credit will automatically be applied to the
                wallet used when purchasing the Deal. Depending on the method of
                payment this can take up to 7-10 business days.
              </li>
            </ul>
