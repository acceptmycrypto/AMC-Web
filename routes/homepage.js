...
router.get("/load/categories/list", function(req, res) {
  connection.query(
    "SELECT DISTINCT id, category_name FROM category WHERE id = 1 OR id = 3 OR id = 4 OR id = 8 OR id = 9 OR id = 10 OR id = 12 OR id = 13;",
...
router.get("/load/categories/list/mobile", function(req, res) {
  connection.query(
    "SELECT DISTINCT id, category_name FROM category WHERE id = 1 OR id = 2 OR id = 3 OR id = 4 OR id = 5 OR id = 6 OR id = 7 OR id = 8 OR id = 9 OR id = 10 OR id = 11 OR id = 12 OR id = 13;",
    function(error, results, fields) {
      if (error) throw error;
      res.json(results);
    }
...
router.get("/home/categorized/deals", function(req, res) {
  ...
  connection.query(query_statement, function(error, results, fields) {
    if (error) console.log(error);
    ...
    connection.query(
      `(SELECT ${recent_select_statement} WHERE deals.deal_status <> ? ORDER BY deals.date_created DESC LIMIT 16)`,
      ["deleted"],
    ...
    //when user hit the homepage, we update the crypto data
